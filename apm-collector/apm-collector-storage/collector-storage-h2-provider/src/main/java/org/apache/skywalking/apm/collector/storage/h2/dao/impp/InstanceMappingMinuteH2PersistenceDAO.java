 ...
 */
public class InstanceMappingMinuteH2PersistenceDAO extends AbstractInstanceMappingH2PersistenceDAO implements IInstanceMappingMinutePersistenceDAO<H2SqlEntity, H2SqlEntity, InstanceMapping> {

    public InstanceMappingMinuteH2PersistenceDAO(H2Client client) {
        super(client);
    }
