 ...
 */
public class InstanceMappingHourH2PersistenceDAO extends AbstractInstanceMappingH2PersistenceDAO implements IInstanceMappingHourPersistenceDAO<H2SqlEntity, H2SqlEntity, InstanceMapping> {

    public InstanceMappingHourH2PersistenceDAO(H2Client client) {
        super(client);
    }
