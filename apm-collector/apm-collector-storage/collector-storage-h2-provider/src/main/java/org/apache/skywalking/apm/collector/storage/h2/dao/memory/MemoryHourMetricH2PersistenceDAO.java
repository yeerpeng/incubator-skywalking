 ...
 */
public class MemoryHourMetricH2PersistenceDAO extends AbstractMemoryMetricH2PersistenceDAO implements IMemoryHourMetricPersistenceDAO<H2SqlEntity, H2SqlEntity, MemoryMetric> {

    public MemoryHourMetricH2PersistenceDAO(H2Client client) {
        super(client);
    }
