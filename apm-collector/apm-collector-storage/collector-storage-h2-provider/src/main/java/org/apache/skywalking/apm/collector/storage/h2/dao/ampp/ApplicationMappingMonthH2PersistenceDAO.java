 ...
 */
public class ApplicationMappingMonthH2PersistenceDAO extends AbstractApplicationMappingH2PersistenceDAO implements IApplicationMappingMonthPersistenceDAO<H2SqlEntity, H2SqlEntity, ApplicationMapping> {

    public ApplicationMappingMonthH2PersistenceDAO(H2Client client) {
        super(client);
    }
