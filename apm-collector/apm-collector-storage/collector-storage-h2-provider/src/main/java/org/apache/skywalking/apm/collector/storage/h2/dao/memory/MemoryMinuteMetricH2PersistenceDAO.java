 ...
 */
public class MemoryMinuteMetricH2PersistenceDAO extends AbstractMemoryMetricH2PersistenceDAO implements IMemoryMinuteMetricPersistenceDAO<H2SqlEntity, H2SqlEntity, MemoryMetric> {

    public MemoryMinuteMetricH2PersistenceDAO(H2Client client) {
        super(client);
    }
