 ...
 */
public class InstanceMappingDayH2PersistenceDAO extends AbstractInstanceMappingH2PersistenceDAO implements IInstanceMappingDayPersistenceDAO<H2SqlEntity, H2SqlEntity, InstanceMapping> {

    public InstanceMappingDayH2PersistenceDAO(H2Client client) {
        super(client);
    }
