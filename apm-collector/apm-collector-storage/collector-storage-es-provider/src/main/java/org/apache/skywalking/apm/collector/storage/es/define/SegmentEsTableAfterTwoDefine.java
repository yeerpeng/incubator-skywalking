 ...
 */
public class SegmentEsTableAfterTwoDefine extends ElasticSearchTableDefine {

    private static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyyMMdd");

    public SegmentEsTableAfterTwoDefine() {
        super(SegmentTable.TABLE + "_" + DATE_FORMAT.format(DateUtils.addDays(new Date(), 2)));
    }
