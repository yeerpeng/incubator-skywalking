 ...
 */
public class GlobalTraceEsTableAfterOneDefine extends ElasticSearchTableDefine {

    private static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyyMMdd");
    public GlobalTraceEsTableAfterOneDefine() {
        super(GlobalTraceTable.TABLE + "_" + DATE_FORMAT.format(DateUtils.addDays(new Date(), 1)));
    }
