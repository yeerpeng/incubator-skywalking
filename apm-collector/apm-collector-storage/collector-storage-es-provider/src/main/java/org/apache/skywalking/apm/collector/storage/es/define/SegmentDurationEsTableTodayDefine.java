 ...
 */
public class SegmentDurationEsTableTodayDefine extends ElasticSearchTableDefine {

    private static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyyMMdd");

    public SegmentDurationEsTableTodayDefine() {
        super(SegmentDurationTable.TABLE + "_" + DATE_FORMAT.format(new Date()));
    }
