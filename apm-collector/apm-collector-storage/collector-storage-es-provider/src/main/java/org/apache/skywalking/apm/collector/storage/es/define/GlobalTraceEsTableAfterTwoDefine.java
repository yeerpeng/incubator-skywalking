 ...
 */
public class GlobalTraceEsTableAfterTwoDefine extends ElasticSearchTableDefine {

    private static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyyMMdd");

    public GlobalTraceEsTableAfterTwoDefine() {
        super(GlobalTraceTable.TABLE + "_" + DATE_FORMAT.format(DateUtils.addDays(new Date(), 2)));
    }
