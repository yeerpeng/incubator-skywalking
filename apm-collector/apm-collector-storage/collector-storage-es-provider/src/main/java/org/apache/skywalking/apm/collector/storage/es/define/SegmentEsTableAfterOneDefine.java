 ...
 */
public class SegmentEsTableAfterOneDefine extends ElasticSearchTableDefine {

    private static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyyMMdd");

    public SegmentEsTableAfterOneDefine() {
        super(SegmentTable.TABLE + "_" + DATE_FORMAT.format(DateUtils.addDays(new Date(), 1)));
    }
