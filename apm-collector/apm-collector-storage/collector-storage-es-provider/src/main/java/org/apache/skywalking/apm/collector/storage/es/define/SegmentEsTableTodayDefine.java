 ...
 */
public class SegmentEsTableTodayDefine extends ElasticSearchTableDefine {

    private static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyyMMdd");

    public SegmentEsTableTodayDefine() {
        super(SegmentTable.TABLE + "_" + DATE_FORMAT.format(new Date()));
    }
