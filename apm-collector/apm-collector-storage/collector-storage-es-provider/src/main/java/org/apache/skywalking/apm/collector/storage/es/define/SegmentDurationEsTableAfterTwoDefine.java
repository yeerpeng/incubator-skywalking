 ...
 */
public class SegmentDurationEsTableAfterTwoDefine extends ElasticSearchTableDefine {

    private static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyyMMdd");

    public SegmentDurationEsTableAfterTwoDefine() {
        super(SegmentDurationTable.TABLE + "_" + DATE_FORMAT.format(DateUtils.addDays(new Date(), 2)));
    }
