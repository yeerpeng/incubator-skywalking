 ...
 */
public class GlobalTraceEsTableTodayDefine extends ElasticSearchTableDefine {

    private static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyyMMdd");
    public GlobalTraceEsTableTodayDefine() {
        super(GlobalTraceTable.TABLE + "_" + DATE_FORMAT.format(new Date()));
    }
